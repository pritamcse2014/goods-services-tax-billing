                        ...
                        <form class="form-horizontal" action="{{ url('admin/parties/add') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="full_name" class="form-control" id="" placeholder="Enter Your Full Name" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Enter Your Phone No <span style="color: red;">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="phone" name="phone_no" class="form-control" id="" placeholder="Enter Your Phone No" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="account_holder_name" class="form-control" id="" placeholder="Enter Your Account Holder Name" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Enter Your Account No <span style="color: red;">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="account_no" class="form-control" id="" placeholder="Enter Your Account No" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Enter Your Bank Name <span style="color: red;">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="bank_name" class="form-control" id="" placeholder="Enter Your Bank Name" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Enter Your IFSC Code <span style="color: red;">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="ifsc_code" class="form-control" id="" placeholder="Enter Your IFSC Code" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">Enter Your Branch Address <span style="color: red;">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="branch_address" class="form-control" id="" placeholder="Enter Your Branch Address" required />
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
